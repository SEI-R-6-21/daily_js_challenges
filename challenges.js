...
function hammingDistance(str1, str2) {
  ...
  for (let i = 0; i < str1.length; i++) {
    if (str1.charAt(i) !== str2.charAt(i)) counts++
  }
  return counts
}
/*-----------------------------------------------------------------
...
function fromPairs(arr) {
  let object = {}
  arr.forEach(function (keyArr) {
    object[keyArr[0]] = keyArr[1]
  })
  return object
}
/*-----------------------------------------------------------------
...
function intersection(arr1, arr2) {
  ...
  arr1.forEach((value) => {
    ...
    if (index > -1) res.push(arr3.splice(index, 1)[0])
  })
  return res
}
/*-----------------------------------------------------------------
