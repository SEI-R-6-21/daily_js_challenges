...
function mumble(string) {
  return string
    .split('')
    .reduce((result, a, b) => result + ((b || '') && '-') + a.repeat(b + 1), '')
}
/*-----------------------------------------------------------------
...
function primeFactors(n) {
  let primeFactors = []
  if (n < 2 || !Number.isInteger(n)) return primeFactors
...
function intersection(arr1, arr2) {
  ...
  let _arr2 = [...arr2]
  arr1.forEach((value) => {
    let index = _arr2.indexOf(value)
    if (index > -1) r.push(_arr2.splice(index, 1)[0])
  })
  return r
}
/*-----------------------------------------------------------------
...
function toCamelCase(string) {
  return string.replace(/[_-]\w/g, function (taco) {
    return taco.charAt(1).toUpperCase()
  })
}
/*-----------------------------------------------------------------
...
function gridTrip(arr, string) {
  ...
  while (idx < string.length) {
    ...
    result[lookup[dir][0]] += nString * lookup[dir][1]
  }
  return result
}
